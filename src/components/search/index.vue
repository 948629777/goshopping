  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector :trademarkList="trademarkList" :attrList="attrList"/>
...
<script>
  ...
  export default {
    ...
    methods:{
      getData(){
        this.searchForm.keyword = this.$route.params.q
      this.$axios({
        method:'post',
        url:'/api/list',
        ...
        this.trademarkList = res.data.data.trademarkList
