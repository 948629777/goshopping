    ...
    <section class="con">
          ...
          <div class="choose">
            <!-- <div class="chooseArea">
              ...
              <dl>
                ...
                <div>
                  <el-radio-group v-model="selectForm.color" size="mini">
      <el-radio-button label="金色" checked></el-radio-button>
      <el-radio-button label="银色"></el-radio-button>
      <el-radio-button label="黑色"></el-radio-button>
              ...
              <dl>
                ...
                <div>
                  <el-radio-group v-model="selectForm.internal" size="mini">
                    <el-radio-button label="16G"></el-radio-button>
      <el-radio-button label="64G"></el-radio-button>
      <el-radio-button label="128G"></el-radio-button>
      <el-radio-button label="256G"></el-radio-button>
    </el-radio-group>
                </div>
              </dl>
              <dl>
                ...
                <div>
                  <el-radio-group v-model="selectForm.versions" size="mini">
                    <el-radio-button label="公开版"></el-radio-button>
      <el-radio-button label="移动版"></el-radio-button>
    </el-radio-group>
                </div>
              </dl>
              <dl>
                ...
                <div>
                  <el-radio-group v-model="selectForm.buyType" size="mini">
                    <el-radio-button label="官方标配"></el-radio-button>
      <el-radio-button label="优惠移动版"></el-radio-button>
      <el-radio-button label="电信优惠版"></el-radio-button>
    </el-radio-group>
                </div>
              </dl>
            </div> -->
      ...
      addGoods(){
        ...
        this.$axios({
          ...
          if(res.data.code==200){
            ...
            this.$router.push('/addgoods/'+this.info.id+'')
          }else{
