            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="item in ordersList" :key="item.id">
                ...
                <tbody>
                  <tr>
                    <td width="60%">
                      <div class="typographic">
                        <img :src="item.orderDetailList[0].imgUrl" style="width: 150px;height: 150px;">
                        <a href="#" class="block-text">{{ item.orderDetailList[0].skuName }}</a>
                        <span>x{{ item.orderDetailList[0].skuNum }}</span>
                        <a href="#" class="service">售后申请</a>
                      </div>
                    </td>
                    <td :rowspan="item.orderDetailList.length" width="8%" class="center">{{ item.consignee }}</td>
                    <td :rowspan="item.orderDetailList.length" width="13%" class="center">
                      <ul class="unstyled">
                        <li>总金额¥{{ item.totalAmount }}</li>
                        <li>{{ item.paymentWay=="ONLINE"?'在线支付':'线下支付' }}</li>

                      </ul>
                    </td>
                    <td :rowspan="item.orderDetailList.length" width="8%" class="center">
                  ...
                  <tr v-for="item1 in item.orderDetailList.slice(1)" :key="item1.id">
                    <td width="50%" >
                      <div class="typographic">
                        <img :src="item1.imgUrl" style="width: 150px;height: 150px;">
